                    ...
                    <div className='col-12 col-md-9'>
                        <LocalForm onSubmit={(values) => this.handleSubmit(values)}>
                            ...
                            <Row className='form-group'>
                                <Col md={{size:6, offset:2}}>
                                    <div className='form-check'>
                                        <Label check>
                                            <Control.checkbox model=".agree" name="agree" className='form-check-input' />{' '} <b>May we contact you?</b>
                                        </Label>
                                    </div>
                                </Col>
                            ...
                            <Row className='form-group'>
                                ...
                                <Col md={10}>
                                    <Control.textarea model=".message" name="message" id="message" rows="12" placeholder="Your Feedback..." className='form-control' />
                                </Col>
                            </Row>
                            <Row className='form-group'>
